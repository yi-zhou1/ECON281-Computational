function [v_new,c,A,saving,dV_Upwind,dVf,dVb,If,Ib,I0] = vfi_iteration(v0,param,num,grid,r,w)
...
[dV_Upwind,dVf,dVb,If,Ib,I0,ssb,ssf] = vp_upwind(v0,param,num,grid,r,w) ;

c = dV_Upwind.^(-1);
%c = dV_Upwind.^(-ggamma);
saving = (1+r)*grid.a + w*param.e - c;
u = utility(c);
X = - min(ssb,0)/grid.da;
