% ECON281 Comp 2024 Spring Week 5 Homework Question 2
% Solve Aiyagari model with income shock and heterogeneous returns
% Author: Yi Zhou
...
w_eqm = (1-param.alpha).*(param.alpha./(r_eqm*param.rshock+param.delta)).^(param.alpha/(1-param.alpha));

[c,saving,l_supply_eqm,k_supply_eqm,g] = household(param,num,grid,r_eqm,w_eqm);
k_demand_eqm = firm(param,r_eqm,l_supply_eqm);
